...
public class BankControllerTest {
	...
	void testCreateAccountOk() {
		when(bankService.createAccount(account.get(0))).thenReturn(ResponseEntity.status(HttpStatus.CREATED).body(account.get(0)));
	...
	void testCreateaccountFailed() {
		when(bankService.createAccount(account.get(0))).thenReturn(ResponseEntity.status(HttpStatus.BAD_REQUEST).body(account.get(0).getAccountNumber()));
		ResponseEntity<Object> response = bankController.createAccount(account.get(0));
	...
	void testCreateMultipleAccountsOk() {
		when(bankService.createMultipleAccounts(account)).thenReturn(ResponseEntity.status(HttpStatus.CREATED).body(account));
	...
	void testCreateMultipleAccountsFailed() {
		when(bankService.createMultipleAccounts(account)).thenReturn(ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Unable to create the requested resources"));
		ResponseEntity<Object> response = bankController.createMultipleAccounts(account);
		assertEquals(HttpStatus.BAD_REQUEST, response.getStatusCode());
	...
	void testGetAccountHolderOk() {
		when(bankService.getAccountHolder(account.get(0).getId())).thenReturn(ResponseEntity.status(HttpStatus.OK).body(account.get(0)));
	...
	void testGetAccountHolderFailed() {
		when(bankService.getAccountHolder(12)).thenReturn(ResponseEntity.status(HttpStatus.NOT_FOUND).body("Resource doesn't exist"));
	...
	void testGetMultipleAccountHoldersFailed() {
		when(bankService.getMultipleAccountHolders()).thenReturn(ResponseEntity.status(HttpStatus.NOT_FOUND).body("No Resource is found"));
		ResponseEntity<Object> response = bankController.getMultipleAccountHolders();
		assertEquals(HttpStatus.NOT_FOUND, response.getStatusCode());
	...
	void testUpdateAccountOk() {
		when(bankService.updateSingleAccount(account.get(0),1 )).thenReturn(ResponseEntity.status(HttpStatus.OK).body(account.get(0)));
	...
	void testUpdateAccountFailed() {
		when(bankService.updateSingleAccount(account.get(0),1 )).thenReturn(ResponseEntity.status(HttpStatus.NOT_FOUND).body("Resource not found for updation"));
		ResponseEntity<Object> response = bankController.updateAccount(account.get(0),1);
		assertEquals(HttpStatus.NOT_FOUND, response.getStatusCode());
	...
	void testUpdateMultipleAccountsOk() {
		when(bankService.updateMultipleAccount(account)).thenReturn(ResponseEntity.status(HttpStatus.OK).body("The patch update on all the accountholders was sucessfull"));
	...
	void testUpdateMultipleAccountsFailed() {
		when(bankService.updateMultipleAccount(account)).thenReturn(ResponseEntity.status(HttpStatus.NOT_FOUND).body(account.get(0).getAccountNumber()));
		ResponseEntity<Object> response = bankController.updateMultipleAccounts(account);
		assertEquals(HttpStatus.NOT_FOUND, response.getStatusCode());
		assertEquals(account.get(0).getAccountNumber(), response.getBody());
	}
	...
	void testUpdateMultipleAccountsFailedDataIntegrity() {
		when(bankService.updateMultipleAccount(account)).thenReturn(ResponseEntity.status(HttpStatus.BAD_REQUEST).body(account.get(0).getAccountNumber()));
		ResponseEntity<Object> response = bankController.updateMultipleAccounts(account);
		assertEquals(HttpStatus.BAD_REQUEST, response.getStatusCode());
		assertEquals(account.get(0).getAccountNumber(), response.getBody());
	}
	...
	void testDeleteSingleAccountOk() {
		when(bankService.deleteSingleAccount(1)).thenReturn(ResponseEntity.status(HttpStatus.OK).body("Resource was sucessfully deleted"));
	...
	void testDeleteSingleAccountFailed() {
		when(bankService.deleteSingleAccount(1)).thenReturn(ResponseEntity.status(HttpStatus.NOT_FOUND).body("Resource not found for deletion"));
		ResponseEntity<Object> response = bankController.deleteSingleAccount(1);
		assertEquals(HttpStatus.NOT_FOUND, response.getStatusCode());
	...
	void testDeleteMultipleAccountsOk() {
		...
		id.add(1);
		id.add(2);		
		when(bankService.deleteMultipleAccounts(id)).thenReturn(ResponseEntity.status(HttpStatus.OK).body("Resources were sucessfully deleted"));
	...
	void testDeleteMultipleAccountsFailed() {
		...
		id.add(1);
		id.add(2);		
		when(bankService.deleteMultipleAccounts(id)).thenReturn(ResponseEntity.status(HttpStatus.NOT_FOUND).body(id.get(0)));
		ResponseEntity<Object> response = bankController.deleteMultipleAccounts(id);
		assertEquals(HttpStatus.NOT_FOUND, response.getStatusCode());
	...
	void testDeleteAllOk() {
		when(bankService.deleteAll()).thenReturn(ResponseEntity.status(HttpStatus.OK).body("Resources were sucessfully deleted"));
